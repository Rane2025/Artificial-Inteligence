...
def load_data(file_path= "imdb_top_1000.csv"):
    try:
        ...
        print(f"{Fore.RED}Error: The dataset file was not found.{Fore.RESET}")
        sys.exit(1)

# 3. Load the data
movies_df = load_data()

# 4. Create TF-IDF matrix and compute cosine similarity
...
def list_genres():
    genres = set()
    for genre_list in movies_df['Genre'].dropna().str.split(','):
